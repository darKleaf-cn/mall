                    ...
                    <div class="cart-items clearfix">
                      ...
                      <div class="operation">
                        <a
                          ...
                          @click="cartdel(item.bookId, item.cartId)"
                        ></a>
                      </div>
                      <!--商品数量-->
                      <div>
...
<script>
import { delCart, addCart } from "@/api/goods";
...
export default {
  ...
  methods: {
    ...mapMutations(["INIT_BUYCART", "EDIT_CART", "ADD_CART", "DEL_CART"]),
    message(m) {
      this.$message.error({
        message: m,
      });
    ...
    EditNum(bookNum, k, cartId, bookId) {
      // 数量
      addCart({
        userId: this.userId,
        cartId,
