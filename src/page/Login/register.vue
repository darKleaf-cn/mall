        ...
        <div class="registered">
          ...
          <div class="content" style="margin-top: 20px;">
            <ul class="common-form">
              <li>
                <div class="input">
                  <input type="tel" v-model="registered.phone" placeholder="手机号">
                </div>
              </li>
            ...
            <div style="margin-bottom: 30px;">
              <y-button
                :classStyle="registered.password&&registered.password2&&registered.userName&&registxt==='注册'?'main-btn':'disabled-btn'"
                :text="registxt" style="margin: 0;width: 100%;height: 48px;font-size: 18px;line-height: 48px"
                @btnClick="regist">
              </y-button>
            </div>
