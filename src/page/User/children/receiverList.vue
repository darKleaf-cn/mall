    ...
    <y-shelf title="收货地址">
      ...
      <div slot="content">
        ...
        <div class="table-title">
          <span class="name">姓名</span> <span class="address">详细地址</span> <span class="receiverPhone">电话</span>
        </div>
...
<script>
  import { receiverList, updateReceiver, addReceiver, delReceiver } from '@/api/goods'
