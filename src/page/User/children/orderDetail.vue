        ...
        >
            ...
            <ul>
              ...
              <li class="button">
                <el-button
                  ...
                  >现在付款</el-button
                >
                <el-button @click="_delOrder()" size="small"
                  >取消订单</el-button
                >
              </li>
            </ul>
          ...
          <div class="goods-table">
            <div class="cart-items" v-for="(item, i) in bookList" :key="i">
              <a @click="bookDetail(item.bookId)" class="img-box"
              ...
              <div class="n-b">
                ...
                <div class="subtotal">
                  ¥ {{ Number(item.price * item.bookNum).toFixed(2) }}
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="order-discount-line">
            ...
            <p class="price-total">
              <span>应付金额：</span
              ><span class="price-red">¥ {{ orderPrice }}</span>
            </p>
          </div>
